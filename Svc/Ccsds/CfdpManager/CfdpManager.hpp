...
class CfdpManager final : public CfdpManagerComponentBase {
  ...
  private:
    ...
    Svc::SendFileResponse fileIn_handler(FwIndexType portNum,                   //!< The port number
  ...
  private:
    ...
    void StopPollDirectory_cmdHandler(FwOpcodeType opCode,  //!< The opcode
                                      U32 cmdSeq,           //!< The command sequence number
    ...
    void SuspendResumeTransaction_cmdHandler(FwOpcodeType opCode,            //!< The opcode
                                             U32 cmdSeq,                     //!< The command sequence number
    ...
    void CancelTransaction_cmdHandler(FwOpcodeType opCode,            //!< The opcode
                                      U32 cmdSeq,                     //!< The command sequence number
                                      U8 channelId,                   //!< Channel ID for the transaction
                                      TransactionSeq transactionSeq,  //!< Transaction sequence number
                                      EntityId entityId               //!< Entity ID of the transaction
    ...
    void AbandonTransaction_cmdHandler(FwOpcodeType opCode,            //!< The opcode
                                       U32 cmdSeq,                     //!< The command sequence number
                                       U8 channelId,                   //!< Channel ID for the transaction
                                       TransactionSeq transactionSeq,  //!< Transaction sequence number
                                       EntityId entityId               //!< Entity ID of the transaction
    ...
    void ResetCounters_cmdHandler(FwOpcodeType opCode,  //!< The opcode
                                  U32 cmdSeq,           //!< The command sequence number
  ...
  public:
    ...
    FileSize getOutgoingFileChunkSizeParam(void);
    ...
    FileSize getRxCrcCalcBytesPerCycleParam(void);
